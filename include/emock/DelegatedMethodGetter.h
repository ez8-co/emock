...
#ifndef __EMOCK_DELEGATED_METHOD_GETTER_H
#define __EMOCK_DELEGATED_METHOD_GETTER_H
...
struct DelegatedMethodGetter
{
	static void* get(unsigned int index)
   {
		switch(index)
      {
#     include <emock/DelegatedMethodGetDef.h>
      default: break;
      }
...
void* getDelegatedFunction(unsigned int vptrIndex, unsigned int vtblIndex, Method m)
{
   ...
   switch(vptrIndex)
   {
#     include <emock/DelegatedMethodGetByVptrDef.h>
   default:
      break;
   }
