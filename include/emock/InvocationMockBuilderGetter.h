...
#ifndef __EMOCK_INVOCATION_MOCK_BUILDER_GETTER_H
#define __EMOCK_INVOCATION_MOCK_BUILDER_GETTER_H

#include <emock/emock.h>

#include <emock/MockBuilder.h>
#include <emock/StubsBuilder.h>
#include <emock/DefaultBuilder.h>
