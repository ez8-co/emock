...
#ifndef __EMOCK_API_HOOK_FUNCTOR_H__
#define __EMOCK_API_HOOK_FUNCTOR_H__
...
#define __EMOCK_API_HOOK_FUNCTOR_DEF(n, CallingConvention, VariadicList) \
template <typename R DECL_TEMPLATE_ARGS(n), unsigned int Seq> \
struct ApiHookFunctor<R CallingConvention (DECL_ARGS(n) VariadicList), Seq> \
{ \
private: \
   typedef R CallingConvention F (DECL_ARGS(n) VariadicList); \
 \
...
template <typename R DECL_TEMPLATE_ARGS(n), unsigned int Seq> \
void* ApiHookFunctor<R CallingConvention (DECL_ARGS(n) VariadicList), Seq>::apiAddress = 0; \
template <typename R DECL_TEMPLATE_ARGS(n), unsigned int Seq> \
...
EMOCK_API_HOOK_FUNCTOR_DEF(0);
EMOCK_API_HOOK_FUNCTOR_DEF(1);
EMOCK_API_HOOK_FUNCTOR_DEF(2);
EMOCK_API_HOOK_FUNCTOR_DEF(3);
EMOCK_API_HOOK_FUNCTOR_DEF(4);
EMOCK_API_HOOK_FUNCTOR_DEF(5);
EMOCK_API_HOOK_FUNCTOR_DEF(6);
EMOCK_API_HOOK_FUNCTOR_DEF(7);
EMOCK_API_HOOK_FUNCTOR_DEF(8);
EMOCK_API_HOOK_FUNCTOR_DEF(9);
EMOCK_API_HOOK_FUNCTOR_DEF(10);
EMOCK_API_HOOK_FUNCTOR_DEF(11);
EMOCK_API_HOOK_FUNCTOR_DEF(12);
