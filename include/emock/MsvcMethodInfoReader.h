...
***/
#ifndef __EMOCK_MSVC_METHOD_INFO_READER_H
#define __EMOCK_MSVC_METHOD_INFO_READER_H
...
void* getAddrOfMethod(Method input)
{
   EMOCK_REPORT_FAILURE("please add /D MSVC_VMG_ENABLED and /vmg to your compiler option");
	return 0;
}
